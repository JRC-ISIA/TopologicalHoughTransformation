...
def create_parser():
    parser = argparse.ArgumentParser(
        description="Parser for the experiments with the topological hough transform.")
    ...
    experiment_group.add_argument("--num-sim-rounds", type=int,
                                  default=10, help="Number of simulation rounds.")
    ...
    experiment_group.add_argument(
        "--line-1-intercept", type=float, default=0., help="Intercept for first line."
    )
    experiment_group.add_argument(
        "--line-1-slope", type=float, default=1.,
        help="Slope for first line.")
    experiment_group.add_argument(
        "--line-2-intercept", type=float, default=0., help="Intercept for second line."
    )
    experiment_group.add_argument(
    ...
    output_group.add_argument("--output-directory", type=str, default='out', help="Path to store the output artifacts.")
